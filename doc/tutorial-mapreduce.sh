...
TERA_SORT_OUTPUT_DIR="gs:///${PARENT_DIR}/tera_sort_data"
...
echo
echo "Cleaning the data created by tests: ${PARENT_DIR} & gs:///${PARENT_DIR}"
echo

CLEANUP_CMD="${HADOOP_CMD} dfs -rmr -skipTrash ${PARENT_DIR} ; ${HADOOP_CMD} dfs -rmr -skipTrash gs:///${PARENT_DIR}"
echo ${CLEANUP_CMD}
eval ${CLEANUP_CMD}
